...
const HELP = {
  ...
  metricCoverage:
    'Ширина × высота зоны покрытия на выбранном расстоянии (метры). W = 2·Z·tan(HFOV/2); для сверхширокого fisheye покрытие ограничено.',
  metricPpm:
  ...
  doriDet: 'DORI Detection (25 px/m, EN 62676-4) — макс. расстояние, на котором заметно присутствие объекта.',
