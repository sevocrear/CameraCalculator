...
const HELP = {
  ...
  sensorW:
    'Ширина матрицы в мм. Влияет на угол обзора: чем шире сенсор при том же f — тем шире FOV.',
  sensorH: 'Высота матрицы в мм. Определяет вертикальный FOV и проекцию по высоте.',
